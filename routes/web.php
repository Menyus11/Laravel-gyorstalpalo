...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/categories/{aitool}', [CategoriesController::class, 'update'])->name('categories.update');
    ...
    Route::patch('/tags/{aitool}', [TagsController::class, 'update'])->name('tags.update');
